...
std::vector<std::vector<Tile>> TestRoom2() {
    return {
        {Tile(4, 4), Tile(4, 5), Tile(4, 5), Tile(4, 5), Tile(4, 5), Tile(1, 0), Tile(4, 1), Tile(4, 1), Tile(4, 1), Tile(4, 2)},
        {Tile(5, 4), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(1, 0), Tile(1, 1), Tile(1, 1), Tile(1, 1), Tile(5, 2)},
        {Tile(5, 4), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(1, 0), Tile(1, 1), Tile(5, 1), Tile(5, 1), Tile(5, 2)},
        {Tile(5, 4), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(1, 0), Tile(5, 1), Tile(1, 1), Tile(1, 1), Tile(5, 2)},
        {Tile(5, 4), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(2, 8), Tile(1, 0), Tile(6, 1), Tile(6, 1), Tile(6, 1), Tile(6, 2)},
        ...
        {Tile(5, 4), Tile(5, 5), Tile(5, 5), Tile(5, 5), Tile(8, 12), Tile(7, 5), Tile(8, 10),  Tile(5, 5),  Tile(5, 6),  Tile(-1, -1)},
